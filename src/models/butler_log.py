...
class ButlerLog(Base):
    ...
    severity    = Column(SAEnum(ButlerSeverity), default=ButlerSeverity.low, nullable=False, index=True)
    ...
    requires_approval = Column(Integer, default=0)  # 0 = auto, 1 = needs confirm, 2 = confirmed
