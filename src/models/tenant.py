...
class Tenant(Base):
    ...
    subdomain = Column(String, unique=True, index=True, nullable=True) # e.g. "mycompany"
    custom_domain = Column(String, unique=True, index=True, nullable=True) # e.g. "app.mycompany.com"
    ...
    agent_profiles = relationship("AgentProfile", back_populates="tenant", cascade="all, delete-orphan")
    ...
    whatsapp_instances = relationship("EvolutionInstance", back_populates="tenant", cascade="all, delete-orphan")
    tickets = relationship("Ticket", back_populates="tenant", cascade="all, delete-orphan")
    vault_credentials = relationship("VaultCredential", back_populates="tenant", cascade="all, delete-orphan")
    preferences = relationship("TenantPreference", back_populates="tenant", uselist=False, cascade="all, delete-orphan")
