...
class AgentProfile(Base):
    ...
    agent_name_display = Column(String(100), nullable=True)   # Nome do agente (ex: "Max", "Sofia")
    agent_avatar = Column(String(10), nullable=True, default="🤖")  # Emoji do agente
    channel = Column(String(50), nullable=True, default="whatsapp")  # Canal: whatsapp, telegram, web
