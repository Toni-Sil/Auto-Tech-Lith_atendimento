...
class Ticket(Base):
    ...
    priority: Mapped[TicketPriority] = mapped_column(
        default=TicketPriority.MEDIUM, index=True
    )

    category: Mapped[str] = mapped_column(
        String, default="general"
    )  # support, sales, inquiry, technical, billing, etc.
    ...
    assigned_user: Mapped[Optional["AdminUser"]] = relationship(
