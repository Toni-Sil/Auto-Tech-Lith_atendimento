...
class Customer(Base):
    ...
    status: Mapped[str] = mapped_column(
        String, default="em_processo"
    )  # em_processo, briefing, proposal, monthly, completed
    source: Mapped[str] = mapped_column(
        String, default="whatsapp"
    ...
    # Funnel Tracking
    funnel_stage: Mapped[Optional[str]] = mapped_column(
        String, nullable=True
    )  # agendado, briefing, proposta, fechado
    status_briefing: Mapped[Optional[str]] = mapped_column(
        String, nullable=True
    )  # pendente, realizado, cancelado
    status_proposta: Mapped[Optional[str]] = mapped_column(
        String, nullable=True
