...
from src.schemas_preferences import (
...
async def update_tenant_settings(
    ...
    """
    pref = await preference_service.update_tenant_preference(db, current_user.tenant_id, data)
    return pref
...
async def get_effective_settings(
    ...
    """
    bundle = await preference_service.get_aggregated_preferences(db, current_user.tenant_id, current_user.id)
    return bundle
