...
from src.schemas.api_key import ApiKeyCreate, ApiKeyResponse, ApiKeyCreationResponse
...
async def create_api_key(
    ...
    """
    key_obj, plain_key = await api_key_service.create_api_key(db, current_user.tenant_id, data)
...
async def delete_api_key(
    ...
    success = await api_key_service.delete_api_key(db, current_user.tenant_id, api_key_id)
    if not success:
